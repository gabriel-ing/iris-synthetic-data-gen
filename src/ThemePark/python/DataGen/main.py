...
def _summary(shifts, tickets, incidents, feedback, queue_snapshot) -> dict:
    ...
    avg_wait = float(queue_snapshot["WaitMinutes"].mean()) if len(queue_snapshot) else 0.0
    ...
    return {
        "counts": {
            ...
            "queue_snapshots": len(queue_snapshot),
        },
        "rates": {
...
def main() -> None:
    ...
    summary = _summary(shifts, tickets, incidents, feedback, queue_snapshot)
